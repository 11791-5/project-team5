...
public class Summary extends TOP {
  ...
  /** getter for variants - gets List of candidate answer variant ids that were merged
            into this final answer.
   * @generated
   * @return value of the feature 
   */
  ...
  /** setter for variants - sets List of candidate answer variant ids that were merged
            into this final answer. 
   * @generated
   * @param v value to set into the feature 
   */
