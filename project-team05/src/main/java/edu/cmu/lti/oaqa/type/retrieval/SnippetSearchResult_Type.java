...
public class SnippetSearchResult_Type extends AnswerSearchResult_Type {
   ...
   */ 
  public int getSnippet(int addr) {
        if (featOkTst && casFeat_snippet == null)
      jcas.throwFeatMissing("snippet", "edu.cmu.lti.oaqa.type.retrieval.SnippetSearchResult");
    return ll_cas.ll_getRefValue(addr, casFeatCode_snippet);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setSnippet(int addr, int v) {
        if (featOkTst && casFeat_snippet == null)
      jcas.throwFeatMissing("snippet", "edu.cmu.lti.oaqa.type.retrieval.SnippetSearchResult");
    ll_cas.ll_setRefValue(addr, casFeatCode_snippet, v);}
  ...
  public SnippetSearchResult_Type(JCas jcas, Type casType) {
    ...
    casFeat_snippet = jcas.getRequiredFeatureDE(casType, "snippet", "edu.cmu.lti.oaqa.type.retrieval.Passage", featOkTst);
